...
/*   Updated: 2024/06/23 14:09:00 by emagnani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	int digit = INT_MAX;
	counted1 = ft_printf("%c\n", (char)digit);
	counted2 = printf("%c\n", (char)digit);
	ft_printf("ft printf a compté %d en lecture et printf %d en lecture\n", counted1, counted2);
	printf("ft printf a compté %d en lecture et printf %d en lecture\n", counted1, counted2);
	return 0;
}